# AJS. Retro Game [![Build status](https://ci.appveyor.com/api/projects/status/qw2ow3sa02ymvmao?svg=true)](https://ci.appveyor.com/project/PolinaKhodus/js-advanced-diploma)
